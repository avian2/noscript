// $ANTLR 3.1.1 ABE.g 2010-05-17 15:45:15
...
org.antlr.lang.augmentObject(ABELexer.prototype, {
    ...
    mINC_TYPE: function()  {
        try {
            ...
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // ABE.g:46:12: ( 'OTHER' | 'SCRIPT' | 'IMAGE' | 'CSS' | 'OBJ' | 'SUBDOC' | 'XBL' | 'PING' | 'XHR' | 'OBJSUB' | 'DTD' )
            var alt7=11;
...
org.antlr.lang.extend(ABELexer.DFA7, org.antlr.runtime.DFA, {
    getDescription: function() {
        return "46:1: INC_TYPE : ( 'OTHER' | 'SCRIPT' | 'IMAGE' | 'CSS' | 'OBJ' | 'SUBDOC' | 'XBL' | 'PING' | 'XHR' | 'OBJSUB' | 'DTD' );";
    },
    dummy: null
});
org.antlr.lang.augmentObject(ABELexer, {
