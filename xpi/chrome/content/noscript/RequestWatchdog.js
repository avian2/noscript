...
const IC_EVAL_PATTERN = fuzzify('eval|set(?:Timeout|Interval)|[fF]unction|Script|toString|Worker|document|')
...
,
  ...
  _dotRx: /\./g,
  _removeDotsRx: /(?:[?&#\/]|^)[\w\.-]+(?=[\/\?&#]|$)|\b(?:[A-Z]|\d)[\w-]*\.[\w\.-]*|=[a-z.-]+\.(?:com|net|org|biz|info|xxx|[a-z]{2})(?:[;&]|$)|\b[a-z.]*[_$1-9][\w.-]*/g,
  _removeDots: function(p) p.replace(InjectionChecker._dotRx, '|'),
  _arrayAccessRx: /\s*\[\d+\]/g,
  _assignmentRx: /^(?:[^\(\)="'.|]+=(?:[^\(='"\[+]+|[\?a-zA-Z_0-9;,&=\/]+|[\d.|]+))$/,
