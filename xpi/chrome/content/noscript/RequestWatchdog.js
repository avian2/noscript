...
const IC_EVAL_PATTERN = fuzzify('eval|set(?:Timeout|Interval)|[fF]unction|Script|toString|Worker|')
  + 'document'
...
,
  ...
  maybeJS: function(expr) {
    ...
    return this._maybeJSRx.test(expr.replace(/(?:^|[\/;&#])[\w\-]+\.[\w\-]+[\?;\&#]/g, '') // remove neutral dotted substrings
    ); 
  },
